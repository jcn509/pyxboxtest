"""Test for the subclasses of :py:class:`pyxboxtest.hdd.HDDMofication`"""
...
def test_add_file(
    ...
    """Ensures that :py:class:`pyxboxtest.hdd.AddFile` actually adds the file
    to the HDD
    """
...
def test_delete_file(filename: str, mock_xqemu_hdd_template_modifier):
    """Ensures that :py:class:`pyxboxtest.hdd.DeleteFile` actually deletes the
    file from the HDD
    """
...
def test_rename_file(
    ...
    """Ensures that :py:class:`pyxboxtest.hdd.RenameFile` actually renames the
    file on the HDD
    """
...
def test_batch_modification(
    ...
    """Ensures that :py:class:`pyxboxtest.hdd.BatchModifcation` actually
